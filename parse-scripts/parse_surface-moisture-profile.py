...
def main():
    ...
    for year in years: 
        ...
        # Calculate absolute humidity. 
            ...
            alt_HMP3[dt.datetime(2022,6,6,10):dt.datetime(2022,7,23,12)] = snow_height['snd'][dt.datetime(2022,6,6,10):dt.datetime(2022,7,23,12)] + 0.8 + 4.7
            alt_HMP4[dt.datetime(2022,6,6,10):dt.datetime(2022,7,23,12)] = snow_height['snd'][dt.datetime(2022,6,6,10):dt.datetime(2022,7,23,12)] + 0.8 + 4.7 + 3.5 

            # After 23 July 2022 raise of mid level booms and some lower adjustments
            alt_HMP2[dt.datetime(2022,7,23,12):dt.datetime(2022,8,20,20,30)] = snow_height['snd'][dt.datetime(2022,7,23,12):dt.datetime(2022,8,20,20,30)] + 0.7
            alt_HMP3[dt.datetime(2022,7,23,12):dt.datetime(2022,8,20,20,30)] = snow_height['snd'][dt.datetime(2022,7,23,12):dt.datetime(2022,8,20,20,30)] + 0.7 + 5.8
            alt_HMP4[dt.datetime(2022,7,23,12):dt.datetime(2022,8,20,20,30)] = snow_height['snd'][dt.datetime(2022,7,23,12):dt.datetime(2022,8,20,20,30)] + 0.7 + 5.8 + 2.9
            ...
            alt_HMP3[dt.datetime(2022,8,20,20,30):] = snow_height['snd'][dt.datetime(2022,8,20,20,30):] + 0.7 + 1.8 + 4
            alt_HMP4[dt.datetime(2022,8,20,20,30):] = snow_height['snd'][dt.datetime(2022,8,20,20,30):] + 0.7 + 1.8 + 4 + 2.9
