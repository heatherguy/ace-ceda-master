...
def main():
    ...
    for year in years: 
        ...
        # Calculate absolute humidity. 
            ...
            alt_HMP3[dt.datetime(2022,7,23,12):dt.datetime(2022,8,20,20,30)] = snow_height['snd'][dt.datetime(2022,7,23,12):dt.datetime(2022,8,20,20,30)]  + 0.7 + 5.7
            alt_HMP4[dt.datetime(2022,7,23,12):dt.datetime(2022,8,20,20,30)] = snow_height['snd'][dt.datetime(2022,7,23,12):dt.datetime(2022,8,20,20,30)] + 0.7 + 5.3 + 3.5
            ...
            alt_HMP2[dt.datetime(2022,8,20,20,30):] = snow_height['snd'][dt.datetime(2022,8,20,20,30):]   + 0.7 + 2.0
            alt_HMP3[dt.datetime(2022,8,20,20,30):] = snow_height['snd'][dt.datetime(2022,8,20,20,30):]  + 0.7 + 5.7
            alt_HMP4[dt.datetime(2022,8,20,20,30):] = snow_height['snd'][dt.datetime(2022,8,20,20,30):] + 0.7 + 5.3 + 3.5
