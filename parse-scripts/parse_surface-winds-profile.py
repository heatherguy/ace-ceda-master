...
def main():
    ...
    for year in years: 
        for month in months:
            ...
            alt_1[dt.datetime(2023,7,27):dt.datetime(2024,7,19,11)] = snow_height['snd'][dt.datetime(2023,7,27):dt.datetime(2024,7,19,11)] + 1
            alt_2[dt.datetime(2023,7,27):dt.datetime(2024,7,19,11)] = snow_height['snd'][dt.datetime(2023,7,27):dt.datetime(2024,7,19,11)] + 1 + 2.4
            alt_3[dt.datetime(2023,7,27):dt.datetime(2024,7,19,11)] = snow_height['snd'][dt.datetime(2023,7,27):dt.datetime(2024,7,19,11)] + 1 + 2.4 + 3.8
            alt_4[dt.datetime(2023,7,27):dt.datetime(2024,7,19,11)] = snow_height['snd'][dt.datetime(2023,7,27):dt.datetime(2024,7,19,11)] + 1 + 2.4 + 3.8 + 7.2

            # 19th July 2024 HMP2 raised
            alt_1[dt.datetime(2024,7,19,11):dt.datetime(2024,7,21,10)] = snow_height['snd'][dt.datetime(2024,7,19,11):dt.datetime(2024,7,21,10)] + 1
            alt_2[dt.datetime(2024,7,19,11):dt.datetime(2024,7,21,10)] = snow_height['snd'][dt.datetime(2024,7,19,11):dt.datetime(2024,7,21,10)] + 3.7
            alt_3[dt.datetime(2024,7,19,11):dt.datetime(2024,7,21,10)] = snow_height['snd'][dt.datetime(2024,7,19,11):dt.datetime(2024,7,21,10)] + 1 + 2.4 + 3.8
