...
def main():
    ...
    sams_data = pd.read_csv(fpath,parse_dates=[1],date_format='%d/%m/%Y %H:%M',index_col=1)
    sams_error = pd.read_csv(fpath_error,parse_dates=[1],date_format='%d/%m/%Y %H:%M',index_col=1)
